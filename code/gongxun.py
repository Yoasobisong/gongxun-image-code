...
class Gongxun:
    def __init__(self, args, ann_model_path = "../ann_pt/ann.pt", 
        ...
        self.yolo_detect_mat = Yolo_detect(mat_model_path, conf=0.80)
        self.yolo_detect_ann = Yolo_detect(ann_model_path, conf=0.80)
